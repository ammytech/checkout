    ...
    <div class="container">
      ...
      <h1 ><?php echo ucfirst($this->router->class);?></h1>
       ...
       <div class="actions float-right">
								...
								<a class="btn default yellow-stripe" href="<?php echo DOMAIN_PATH . $this->router->class . '/addProduct';?>">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo '<br><h4>'.$row['title'].'</h4>'; ?> </td>
				 <td><?php echo((!empty($row['img']) && file_exists(PRODUCT_IMG_ABS_PATH.$row['img']))? '<img src="'.PRODUCT_IMG_PATH.str_ireplace('_500x400', '_100x80', $row['img']).'">' : ''); ?></td>
